...
class CVApi(DataMonitor):
    ...
    def get_oracle_backup_job_list(self, client_name):
        oracle_backup_sql = """SELECT DISTINCT [jobid],[backuplevel],[startdate],[enddate],[instance], [nextSCN], [idataagent], [subclient], [storagePolicy], [numbytesuncomp]
                            ...
                            WHERE [jobstatus]='Success' AND [clientname]='{0}' AND [subclient]='default' AND [backuplevel]='Online Full' ORDER BY [startdate] DESC;""".format(
            client_name)
...
if __name__ == '__main__':
    credit = {
        "host": "192.168.100.222\COMMVAULT",
        "user": "sa_cloud",
        "password": "1qaz@WSX",
        "database": "CommServ",
    }
